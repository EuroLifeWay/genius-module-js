...
// оператор delete user.age удаляет свойствочто может
// замедлить работу кода (деоптимизация). Лучшие альтернативы:
// установить значение undefined (user.age = undefined;)null
// или создать новый объект без этого поля с помощью
// деструктуризации: const { age...newUser } = user;
// Примечание: Оператор delete удаляет свойство из объекта
// после чего in вернет false.
